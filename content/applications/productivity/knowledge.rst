...
The pages on which they gather content are called *articles*, and are mainly composed of a title and
a body. The latter is an HTML field containing text, images, links to other articles, records from
other models, templates, etc.
